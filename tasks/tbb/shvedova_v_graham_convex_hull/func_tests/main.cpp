...
template <typename Task = shvedova_v_graham_convex_hull_tbb::GrahamConvexHullTBB>
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_triangle) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_square_inner) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_identical_points) {
  ...
  shvedova_v_graham_convex_hull_tbb::GrahamConvexHullTBB task(data);
  ASSERT_FALSE(task.Validation());
}

TEST(shvedova_v_graham_convex_hull_tbb, convex_collinear_diagonal) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_collinear_vertical) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_collinear_horizontal) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_invalid_too_few) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_invalid_odd_coords) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_rhomb) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_square) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_rhomb_inner) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_square_inner_complex) {
...
TEST(shvedova_v_graham_convex_hull_tbb, convex_random) {
...
TEST(shvedova_v_graham_convex_hull_tbb, PentagonWithPointsInside) {
...
TEST(shvedova_v_graham_convex_hull_tbb, random_48) {
...
TEST(shvedova_v_graham_convex_hull_tbb, random_64) {
